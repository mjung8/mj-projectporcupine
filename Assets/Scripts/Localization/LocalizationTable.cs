...
namespace ProjectPorcupine.Localization
{
    ...
    public static class LocalizationTable
    {
        ...
        /// <summary>
        /// Load a localization file from the hard drive.
        /// </summary>
        ...
        /// </summary>
        /// <param name="path">Path to the file.</param>
        /// <param name="localizationCode">Localization code (i.e. language, e.g. en_US)</param>
        ...
        /// <param name="additionalValues">Values to insert.</param>
        /// <returns></returns>
